               ...
               <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                  ...
                  <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div id="c1" class="border border-gray-500 p-4">
                        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Показания электросчетчика</h2>
                    </div>
                  </div>
                  ...
                  <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div id="c2" class="border border-gray-500 p-4">
                        <table class="min-w-full table-auto border-collapse bg-white text-sm">
                            ...
                            <tbody>
                                @if(session()->has('electro_list'))
                                    @php
                                        $electro = session('electro_list');
                                    @endphp
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="border border-gray-300 px-4 py-2 text-gray-700">{{ number_format($electro->summ, 2) }}</td>
                                    </tr>
                                @else
                                    <tr>
                                        <td colspan="3" class="border border-gray-300 px-4 py-2 text-center text-red-500">No data available</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                  ...
                  <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div id="c1" class="border border-gray-500 p-4">
                        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Целевые расходы</h2>
                    </div>
                  </div>

                  <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg"> 
                  <div id="c2" class="border border-gray-500 p-4">                 
                     @if(!session()->has('balance_list'))
