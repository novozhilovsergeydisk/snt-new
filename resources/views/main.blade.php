...
<header id="navbar" class="header d x q hc">
    <div class="hb hc md sf xn yn mo xp 2xl:ud-px-20">
        ...
        <div class="menu-wrapper c x q ea xb hc pd af lf zj zm an kn mn zn ho jo mp sp">
            <div class="hc zd">
                <nav>
                    <ul id="desktop-menu" class="navbar hb ld od pd wd lh wn zn ao bo">
                        <li>
                            <a href="/" data-url="--http://127.0.0.1:8002" class="menu-scroll ib od pd lh mh sh gi cj ik">Главная</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/contacts" class="menu-scroll ib od pd lh mh sh gi cj ik">Контакты</a>
                        </li>
                    </ul>
...
-->
        ...
        <div class="d y/2 v ea hb ed/2 od an vn">
            ...
            <button id="menu-toggler" class="menu-toggler e ea fi ck ln">
...
<section id="home" class="mb-3 e da _d pt-20 pb-3 to"> <!-- class: gl -->
    <ul id="mobile-menu" class="rf xi pt-4 pb-4 text-white hidden">
        <li>
            <a href="/" data-url="--http://127.0.0.1:8002" class="menu-scroll ib od pd lh mh sh gi cj ik">Главная</a>
        </li>
        <li>
...
<script>
    // Функция для отладки
    function o(debug) {
        console.log( debug ); // Выводим элемент, по которому был клик
    }
